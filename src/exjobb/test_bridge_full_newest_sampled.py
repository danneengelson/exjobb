...
RESULTS_FILE = 'brdige_newest_sampled.dictionary'
HYPER_MAX_EVAL = 100
...
ALGORITHMS = {
    "Newest Sampled BA*": {
        "name": "Newest Sampled BA* & Inward Spiral",
        "do_hyper": True,
        ...
        "cpp": lambda print, motion_planner, cov_points, time_limit, parameters: RandomBAstar3(print, motion_planner, PointCloud(print, points= cov_points), time_limit, parameters), 
        'line': 'g',
