...
from exjobb.Parameters import CELL_SIZE, FLOOR_LEVEL_HEIGHT_THRESSHOLD, GROUND_OFFSET, MAX_STEP_HEIGHT, MIN_FLOOR_HEIGHT, MIN_POINTS_IN_CELL, ROBOT_SIZE, Z_RESOLUTION
import pickle
...
class TerrainAssessment():
    ...
    def get_classified_points(self):
        ...
        segmentized_floors, floor_segmentation_stats = self.floor_segmentation.get_segmentized_floors(self.pcd, False)
        stats = {
        ...
        stats["Parameters"] = {
            ...
            "FLOOR_LEVEL_HEIGHT_THRESSHOLD": FLOOR_LEVEL_HEIGHT_THRESSHOLD,
