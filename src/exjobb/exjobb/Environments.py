...
class MapEnvironment(Environment):
    def __init__(self, print, cache_dictionary, map_file, resolution):
        self.map = Map(print, map_file, resolution)
        super().__init__(print, cache_dictionary)
        
        self.full_pcd = self.map.map_to_full_pcd()
    ...
    def do_terrain_assessment(self):
        ...
        traversable_points, coverable_points = self.map.get_traversable_and_coverable_points()
        inaccessible_points = []
...
class PointCloudEnvironment(Environment):
    ...
    def do_terrain_assessment(self):
        ...
        Returns:
            Coverable points and their indices in the point cloud as NumPy arrays.
        '''
        terrain_assessment = TerrainAssessment(self.print, self.full_pcd)
