...
PRE_RESULTS_FILE = 'garage_bastar_sampled.dictionary'
RESULTS_FILE = 'garage_bastar_sampled_212.dictionary'
HYPER_MAX_EVAL = 100
...
def main():
    ...
    with open(PRE_RESULTS_FILE, 'rb') as cached_pcd_file:
        cache_data = pickle.load(cached_pcd_file)
        ALGORITHMS = cache_data
        for alg in ALGORITHMS:
            ALGORITHMS[alg]["do_hyper"] = False
            ALGORITHMS[alg]["do_experiment"] = False
