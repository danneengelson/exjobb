...
from exjobb.Parameters import ROBOT_SIZE, MARGIN, CELL_SIZE
...
class PointClassification():
    ...
    def get_classified_points(self, ground_points_idx, uncoverable_border_points):
        ...
        return self.pcd.points[traversable_points_idx], self.pcd.points[real_coverable_points_idx], self.pcd.points[false_coverable_points_idx.astype(int)]
