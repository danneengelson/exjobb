...
\begin{document}
	...
	The task investigated in this paper is that of CPP for autonomous road sweeping, where the input is a point cloud and the output is a collision free path with highest possible coverage while minimizing path length and total rotation.
	...
	%TODO: Move offline argumentation to "Scenario"-section?
	Stoff:
	\begin{itemize}
		...
		\item Complex environments. Outdoor. Hard to guarantee 100\% coverage..? It is in the point-cloud case. Any planar/grid/voxel approximation that we can achieved 100\% coverage in will still (as an approximation) not cover 100\% of coverable space in the point cloud...?
	\end{itemize}
...
%	\end{itemize}
	...
	\textbf{TODO}: Applying CPP algorithm. Domain adaptation with Parameter optimization.. Meta-algorithm?\\
